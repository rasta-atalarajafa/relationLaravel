...
<body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('https://images.unsplash.com/photo-1580149959197-e48d1f587067?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1436&q=80');"      data-stellar-background-ratio="0.5">
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
                ...
                <div class="col-md-12 ftco-animate">
                    ...
                    <h1 class="mb-4 mb-md-0">Rasta blog</h1>
                    <div class="row">
                        <div class="col-md-7">
                            <div class="text">
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="img mr-4 rounded" style="background-image: url({{ url('frontend/images/image_1.jpg') }});"></a>
                            <div class="text">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="img mr-4 rounded" style="background-image: url({{ url('frontend/images/image_2.jpg') }});"></a>
                            <div class="text">
                                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a>
                                </h3>
                                <div class="meta">
